...
enum InnoSubInFaults {
  ...
  INNO_SUB_FAULT_REFINTENSITY2_0,
  INNO_SUB_FAULT_REFINTENSITY2_1,
  INNO_SUB_FAULT_REFINTENSITY2_2,
  INNO_SUB_FAULT_REFINTENSITY2_3,
  INNO_SUB_FAULT_MAX
};
...
static const struct InnoInFaults Inno_faults_def[INNO_LIDAR_IN_FAULT_MAX] = {
  ...
  {"INNO_LIDAR_IN_FAULT_WINDOW_BLOCKAGE1",   INNO_CONFIDENCE_LEVEL_LOW,
    (1U << INNO_LIDAR_MODE_WORK_CALIBRATION)},
  ...
  {"INNO_LIDAR_IN_FAULT_LASER_INTERLOCK",    INNO_CONFIDENCE_LEVEL_NONE,
    0},
  {"INNO_LIDAR_IN_FAULT_COMM_LASER",         INNO_CONFIDENCE_LEVEL_NONE,
    0},
  {"INNO_LIDAR_IN_FAULT_LASER",              INNO_CONFIDENCE_LEVEL_NONE,
    0},
  ...
  {"INNO_LIDAR_IN_FAULT_DATA_DROP4",         INNO_CONFIDENCE_LEVEL_NONE,
    0},
  {"INNO_LIDAR_IN_FAULT_RESERVED08",         INNO_CONFIDENCE_LEVEL_NONE,
    0},
  ...
  {"INNO_LIDAR_IN_FAULT_GALVO_OFFSET",       INNO_CONFIDENCE_LEVEL_FULL,
    0},
  {"INNO_LIDAR_IN_FAULT_RESERVED15",         INNO_CONFIDENCE_LEVEL_FULL,
    0},
  {"INNO_LIDAR_IN_FAULT_RESERVED16",         INNO_CONFIDENCE_LEVEL_FULL,
    0},
  {"INNO_LIDAR_IN_FAULT_RESERVED17",         INNO_CONFIDENCE_LEVEL_FULL,
    0},
